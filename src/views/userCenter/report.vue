<template>
  <div style="height:100%" :class="{'user-list':true,'collapse':collapse,'uncollapse':!collapse}" >
    ...
    <div class="bottom-table-box bottom-table-box-khbb">
      ...
      <div class="col-4">
<!--        <div id="mychart"></div>-->
        <reportEchars v-model="communityCode" :chartType="1" :communitySelect="communitySelect" :loadData="loadData"></reportEchars>
      </div>
      <!--右边表格//-->
    </div>
  </div>
  ...
  data() {
    return {
      ...
      tableTiltes: [
        ...
        { name: "用户类型", code: "userType" },
        { name: "联系电话", code: "contactMobile" },
        { name: "欠费金额", code: "arrearsMoney" },
        { name: "欠费次数", code: "arrearsCount" },
        { name: "消除欠费次数", code: "removeArrearsCount" },
        { name: "累计欠费次数", code: "totalArrearsCount" }
      ],
