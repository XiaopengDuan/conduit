  ...
  <div style="flex: 1 1;">
    <div class="sharetitle">
      ...
      <div class="input-group-btn">
        <el-select  @change="findNightMinWaterAnalysisPage1" v-model="communityCode" placeholder="请选择地域">
          <el-option
...
<script>
  ...
  import { getNightMinWaterAnalysisPage1 } from '@/api/chargeWater'
  export default {
    ...
    mounted() {
      ...
      // this.drawEcharts()
      this.findNightMinWaterAnalysisPage1()
    },
    methods: {
      handleSelect(item){
      ...
      findNightMinWaterAnalysisPage1(){
        this.$store.dispatch('app/openLoading')
        getNightMinWaterAnalysisPage1({
