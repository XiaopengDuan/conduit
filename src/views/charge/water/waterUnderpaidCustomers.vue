...
<script>
  ...
  import { getCommunityWaterVolatilityAnalysisByComCode } from '@/api/chargeWater'
  ...
  export default {
    ...
    methods: {
      ...
      findUseWaterVolatilityAnalysisByUserNo(){
        ...
        getCommunityWaterVolatilityAnalysisByComCode({communityCode: this.$route.params.communityCode}).then(r => {
