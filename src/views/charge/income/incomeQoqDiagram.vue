...
<script>
  ...
  import { get67UserChargeAndShouldMoneyYtyQoqChangeCurve } from '@/api/charge'
  export default {
        ...
        let option = option = {
         ...
         tooltip: {
          confine: true,
            ...
            formatter: function (values, index) {
              ...
              values.forEach((value,index)=>{
                str += `${value.seriesName}: ${value.value}</br>`
              })
              return str
            }
          },
          ...
          series: [{
            ...
            data: that.changeCurve.nowTotalMoney,
            itemStyle: {
              color: '#00E0FE'
            }
          },{
            ...
            data: that.changeCurve.lastTotalMoney,
            itemStyle: {
              color: '#FFD400'
            }
          }]
