    ...
    export default {
        ...
        methods: {
            ...
            getRandomImg() {
                ...
                let number = this.getRandomNumberByRange(1,6)
                return require('../../assets/img/verify'+number+'.jpg')
            },
            ...
            bindEvents() {
                document.addEventListener('mousemove', (e) => {
                    ...
                    this.sliderMaskWidth = moveX + 40 + 'px';
...
<style scoped>
    ...
    .slide-verify-refresh-icon {
        ...
        height: 34px;
        cursor: pointer;
        background: url("../../assets/img/icon_light.png") 0 -437px;
    ...
    .slide-verify-slider-mask-item-icon {
        ...
        width: 14px;
        height: 12px;
        background: url("../../assets/img/icon_light.png") 2px -26px;
        background-size: 34px 471px
    }
